piece_positions = {
    ...
    'position_3': {'max_pieces': 1,
                   'pieces': [],
                   'title': 'Train Engineers',
                   'actions': {
                        'get_resources': {'purple': 1}
                    }
                   },
    'position_4': {'max_pieces': 1,
                   'pieces': [],
                   'title': 'Hire Teachers',
                   'actions': {
